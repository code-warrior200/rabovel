...
export const DepositScreen: React.FC = () => {
  ...
  const handleDeposit = async () => {
    ...
    Alert.alert(
      'Deposit Initiated',
      `Your deposit of ${formatCurrency(parseFloat(amount), currency)} has been initiated. It will be processed shortly.`,
      [
        {
          text: 'OK',
        ...
        >
          ...
          <View style={styles.infoSection}>
            ...
            <Text style={[styles.infoText, { color: theme.colors.text.tertiary }]}>
              Deposits are processed instantly. Minimum deposit is {formatCurrency(1000, currency)}.
            </Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
